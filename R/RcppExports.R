...
createEngine <- function(embeddingDimension, locationCount, truncation, tbb, simd, gpu) {
    .Call('_mds_createEngine', PACKAGE = 'mds', embeddingDimension, locationCount, truncation, tbb, simd, gpu)
}
